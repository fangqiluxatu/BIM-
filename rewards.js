...
const calculate = (balance, account, isTransfer) => {
  ...
  stackArr.map(user => {
    const fukcers = ['fibosfeijiaa', 'imeos2imeos2', 'simplesimple', 'huobipool123','wangyongmei1'] // TODO 需要分红的名单
    const percent = 0.8 // TODO 分红的百分比
  ...
  const myOtherAccount = 'cnblockchain' // TODO 剩余转账到小号
